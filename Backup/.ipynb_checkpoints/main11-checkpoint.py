...
def train_model(model, train_loader, val_loader, num_epochs=100, learning_rate=1e-3, alpha=1.0, patience=100):
...
def main():
    ...
    print("Training complete. Best model saved in 'Experiments/33/best_model.pth'")
